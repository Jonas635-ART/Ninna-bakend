...
# al momento de llamar a la funcion tenemos que pasarle el mismo numero de parametros 
#que hemos definido
...
# si una funcion retorna mas de un valor (retornara una tupla) 
# entonces podemos hacer dos cosas: 
# 1. si solamente declaramos una variable ahi se almacenara toda la tupla, 
# 2. si queremos almacenar cada valor de la tupla en una variable podemos hacer una destructuracion de esa tupla declarando el mismo numero de variables que el numero de contenidos de la tupla
...
# * las llamas recursivas son mas costosas ya que ocupan mas memoria por el simple echo de volver a 
# llamar a toda la funcion de nuevo dentro de si misma y obviamente esto generara un mayor tiempo de respuesta
# * las funciones recursivas son dificiles de hace depuracion (seguimiento al codigo linea x linea)

# Operador ternarios
# son condicionales que se pueden realizar en una sola linea de codigo solamente se puede 
# retornar un valor o varios valores pero en una sola linea, 
# no se puede hacer validaciones adicionales a la principal
