...
class Persona:
    ...
    # en cada metodo siempre como primer parametro obligatoriamente se utiliza la palabra self 
    # sirve para hacer referencia dentro de la instancia a los atributos y metodos de esa misma instancia para que haga uso de esa copia 
    # y que posiblemente no traiga la informacion estatica de la clase
    def saludar(self):
        self.decir_nombre()
        self.fec_nac
...
# sobre escribimos el valor predeterminado del atributo nombre a uno nuevo y 
# esto generara que si las instancias que siguen usando el atributo con su valor original cambien a este nuevo valor ya que es un atributo estatico
