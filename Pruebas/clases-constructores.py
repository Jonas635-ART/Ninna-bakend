class Animal:
    ...
    def descripcion(self):
        # si queremos que los atributos que vamos a utilizar sean creados y puedan ser accedidos desde 
        # cualquier parte de la instancia de la clase entonces los deberemos de crear en el constructor 
